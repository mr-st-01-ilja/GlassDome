...
pya.alert(text='Warning! Malware Detected!', title='Windows Malware Protection', button='Ok', )
pya.confirm(text='PRESS OK', title='V1RU5', buttons=['OK', 'OK', ])
pya.password(text='TYPE YOUR PASSWORD', title='V1RU5', default='', mask='*')
